...
const couplePool = [
  ...
  { src: '/assets/images/white-rig-square.webp', alt: 'Elegant white DJ booth setup with Mr & Mrs facade', tag: 'Elegant white setup' },
  ...
  { src: '/assets/images/gallery-bride-dancing.webp', alt: 'Bride dancing and celebrating on the dancefloor', tag: 'Dancefloor energy' },
